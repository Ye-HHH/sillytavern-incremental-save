...
export async function countTokensOpenAIAsync(messages, full = false) {
    ...
    for (const message of messages) {
        ...
        if (typeof cachedCount === 'number') {
            ...
            // Fast estimation: use char-based approximation
